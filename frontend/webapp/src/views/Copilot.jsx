    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 space-y-2">
        ...
        <div className="space-y-1">
          <label htmlFor="ai-req" className="block text-sm text-slate-400">{t('copilot.request')}</label>
          <textarea id="ai-req" className="w-full bg-slate-800 rounded-lg px-3 py-2 text-sm" rows={2}
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 space-y-2">
        ...
        <div className="space-y-1">
          <label htmlFor="ai-logs" className="block text-sm text-slate-400">{t('copilot.logs')}</label>
          <textarea id="ai-logs" className="w-full bg-slate-800 rounded-lg px-3 py-2 text-xs font-mono" rows={5}
